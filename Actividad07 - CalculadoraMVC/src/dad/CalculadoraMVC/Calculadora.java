...
public class Calculadora {
	...
	public CalculadoraView mostrarVista;
	...
	private ReadOnlyStringWrapper pantalla;
	
	public Calculadora() {
		pantalla = new ReadOnlyStringWrapper(this,"pantalla","0.0");
		borrar();
	}
	...
	public javafx.beans.property.ReadOnlyStringProperty pantallaProperty() {
		return this.pantalla.getReadOnlyProperty();
	}
